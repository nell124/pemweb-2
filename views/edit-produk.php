                        ...
                        <div class="card-body">
                            <form action="edit-produk.php?id=<?= $user['id'] ?>" method="POST">
                                <div class="mb-3">
                                    ...
                                    <input type="text" class="form-control" id="kode" name="kode" value="<?= $user['kode'] ?>" required>
                                </div>
                                <div class="mb-3">
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="text" class="form-control" id="harga" name="harga" value="<?= $user['harga'] ?>" required>
                                </div>
                                <div class="mb-3">
                                    <label for="stok" class="form-label">Stok</label>
                                    <input type="text" class="form-control" id="stok" name="stok" value="<?= $user['stok'] ?>" required>
                                </div>
                                <div class="mb-3">
                                    <label for="jenis_produk_id" class="form-label">Jenis Produk ID</label>
                                    <input type="text" class="form-control" id="jenis_produk_id" name="jenis_produk_id" value="<?= $user['jenis_produk_id'] ?>" required>
                                </div>
