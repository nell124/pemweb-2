  ...
  <div class="form-group row">
    ...
    <div class="col-8">
      <div class="input-group">
        ...
        <input id="nim" name="nim" placeholder="*0110124041" type="text" class="form-control" required="required" pattern="[0-9]{10}" tittle="NIM harus 10 Digit Angka">
      </div>
    </div>
  </div>
  <div class="form-group row">
    ...
    <div class="col-8">
      <div class="input-group">
        ...
        <input id="nama_lengkap" name="nama_lengkap" placeholder="*Nailah Hana" type="text" class="form-control" required="required" minlenght="3" maxlenght="50">
      </div>
    </div>
  </div>
  <div class="form-group row">
